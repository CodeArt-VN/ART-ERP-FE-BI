...
const routes: Routes = [
  {
    ...
    children: [
      ...
      },
      {
        ...
        children: [
          {
            loadChildren: () => import('./tabs/sale-product/sale-product.module').then((m) => m.SaleProductPageModule),
            path: '',
            canActivate: [AuthGuard],
          },
        ],
      },
      {
        ...
        children: [
          {
            loadChildren: () => import('./tabs/sale-outlet/sale-outlet.module').then((m) => m.SaleOutletPageModule),
            path: '',
            canActivate: [AuthGuard],
          },
        ],
