...
export class SaleDailyReportPage extends PageBase {
  ...
  dataPnL = [
    {
      title: 'Gross Revenues <br> Doanh thu gộp',
      value: 100,
      data: [
    ...
    {
      title: 'Net Revenues <br> Doanh thu thuần',
      value: 100,
      data: [
        { title: 'Wedding <br> Tiệc cưới', value: 70 },
        { title: 'Events <br> Tiệc công ty', value: 25 },
    ...
    {
      title: 'COGS (Variable cost) <br> Giá vốn (Biến phí)',
      value: -75,
      data: [
        { title: 'Foods <br> Thức ăn', value: -50 },
        { title: 'Berevage <br> Thức uống', value: -20 },
        {
          title: 'Daily staff cost (CL) <br> Nhân công trực tiếp (CL)',
          value: -5,
        },
      ],
    },
    {
      title: 'COGS (Fixed cost) <br> Giá vốn (Định phí)',
      value: -5,
      data: [
    ...
    this.rpt.rptGlobal.branch.forEach((b) => {
      data.datasets.push({
        ...
        data: [
          ...
          this.rpt.randomScalingFactor(20, 30),
          this.rpt.randomScalingFactor(40, 70),
          this.rpt.randomScalingFactor(50, 80),
          this.rpt.randomScalingFactor(40, 80),
          this.rpt.randomScalingFactor(60, 90),
          this.rpt.randomScalingFactor(60, 100),
        ],
      });
    });
  ...
  toogleBranchDataset(b) {
    ...
    let charts = [this.soLuongTiecChart, this.pnlChart, this.cashFlowChart];
