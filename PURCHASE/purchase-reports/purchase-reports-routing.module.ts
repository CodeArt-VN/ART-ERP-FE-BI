...
const routes: Routes = [
	{
		...
		children: [
			...
			},
			{
				...
				children: [
					{
						loadChildren: () => import('./tabs/purchase-buyer/purchase-buyer.module').then((m) => m.PurchaseBuyerPageModule),
						path: '',
						canActivate: [AuthGuard],
					},
				],
			},
			{
				...
				children: [
					{
						loadChildren: () => import('./tabs/purchase-product/purchase-product.module').then((m) => m.PurchaseProductPageModule),
						path: '',
						canActivate: [AuthGuard],
					},
				],
			},
			{
				...
				children: [
					{
						loadChildren: () => import('./tabs/purchase-vendor/purchase-vendor.module').then((m) => m.PurchaseVendorPageModule),
						path: '',
						canActivate: [AuthGuard],
					},
				],
